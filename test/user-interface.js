...
tap.test('User.getInfo() test', function (tap) {
  const now = new Date();
  const year = now.getFullYear();
  
  tap.test('Normal birthdate ', function (tap) {
    const byear = 1985;
  ...
  tap.test('Wrong ', function (tap) {
    const birthdate = '5011-20-45';
    const age = user.getAge(birthdate);
    user.setSign();
    const sign = user.sign;
    tap.equal(user.getInfo(birthdate),
...
tap.test('User.getSign() test', function (tap) {
  tap.test('Sign empty', function (tap) {
    user.birthdate = '';
    user.setSign();
    tap.equal(user.sign, '');
  ...
  tap.test('Sign Aquarius', function (tap) {
  ...
  tap.test('Sign Pisces', function (tap) {
  ...
  tap.test('Sign Ares', function (tap) {
  ...
  tap.test('Sign Taurus', function (tap) {
  ...
  tap.test('Sign Gemini', function (tap) {
  ...
  tap.test('Sign Cancer', function (tap) {
  ...
  tap.test('Sign Leo', function (tap) {
  ...
  tap.test('Sign Virgo', function (tap) {
  ...
  tap.test('Sign Libra', function (tap) {
  ...
  tap.test('Sign Scorpio', function (tap) {
  ...
  tap.test('Sign Saggitarius', function (tap) {
  ...
  tap.test('Sign Capricorn', function (tap) {
